 ...
 */
public class ListArray extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtNameCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtRut, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        Cliente cliente = new Cliente(txtRut.getText(), txtNameCliente.getText(), txtDireccion.getText(), txtTelefono.getText());
        lista.add(cliente);
        mostrar();
        txtRut.setText(null);
        txtNameCliente.setText(null);
    ...
    public void mostrar(){
        ...
        for(int i=0; i < lista.size();i++){
            ...
            matrix[i][1]=lista.get(i).getRut();
            matrix[i][2]=lista.get(i).getDireccion();
            matrix[i][3]=lista.get(i).getTelefono();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListArray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void add(String cliente) {
